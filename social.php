...
class Widget_KT_Social extends WP_Widget {
	...
	public function widget( $args, $instance ) {
       ...
       //Defaults
        ...
        if ($youtube) {
            $social_icons .= '<a target="_blank" href="http://www.youtube.com/channel/'.esc_attr( $youtube ).'" title ="'.__( 'Youtube', 'kutetheme' ).'"><i class="fa fa-youtube"></i></a>';
        }
        if ($pinterest) {
        ...
        if ($instagram) {
            $social_icons .= '<a target="_blank" href="http://github.com/'.esc_attr( $instagram ).'" title ="'.__( 'Github', 'kutetheme' ).'" ><i class="fa fa-git-square fa-2x" style="color:red"></i></a>';
        }
